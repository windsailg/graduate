...
$('#Shao').click(function(){
	...
	$(this).toggleClass('active').children('.img_box').removeClass('animated');
	$('#Chen').toggleClass('active').children('.img_box').addClass('animated');
...
$('#Chen').click(function(){
	...
	$(this).toggleClass('active').children('.img_box').removeClass('animated');
	$('#Shao').toggleClass('active').children('.img_box').addClass('animated');
	$('#IntroContentShao').toggleClass('active');
	$('#IntroContentChen').toggleClass('active');
});
...
var resizeTimer = null;
   $(window).resize(function(){
	...
	resizeClasser();
	function resizeClasser(){
		var ww = window.innerWidth;
		if(ww <= 1300){
			$('#Shao').addClass('active').children('.img_box').removeClass('animated');
			$('#Chen').addClass('active').children('.img_box').removeClass('animated');
		}else{
